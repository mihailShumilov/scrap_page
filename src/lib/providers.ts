export const providers: Array<{
    provider_name: string; provider_url: string; endpoints: Array<{ schemes?: Array<string>, url?: string, formats?: Array<string>, discovery?: boolean }>
}> = [{
    "provider_name": "23HQ",
    "provider_url": "http://www.23hq.com",
    "endpoints": [{"schemes": ["http://www.23hq.com/*/photo/*"], "url": "http://www.23hq.com/23/oembed"}]
},
    {
        "provider_name":
            "Abraia",
        "provider_url":
            "https://abraia.me",
        "endpoints":
            [{"schemes": ["https://store.abraia.me/*"], "url": "https://api.abraia.me/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "http://www.adways.com",
        "endpoints":
            [{"schemes": ["http://play.adpaths.com/experience/*"], "url": "http://play.adpaths.com/oembed/*"}]
    }
    ,
    {
        "provider_name":
            "Alpha App Net",
        "provider_url":
            "https://alpha.app.net/browse/posts/",
        "endpoints":
            [{
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://app.altrulabs.com/*/*?answer_id=*"],
    ...
    ,
    {
        ...
        "provider_url":
            "http://animoto.com/",
        "endpoints":
            [{"schemes": ["http://animoto.com/play/*"], "url": "http://animoto.com/oembeds/create"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://audioboom.com/channel/*", "https://audioboom.com/posts/*"],
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://app.avocode.com/view/*/_/comments/"],
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://backtracks.fm/*/*/e/*", "https://backtracks.fm/*", "http://backtracks.fm/*"],
    ...
    ,
    {
        ...
        "endpoints":
            [{"url": "https://www.beautiful.ai/api/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"url": "http://boxofficebuz.com/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://cacoo.com",
        "endpoints":
            [{"schemes": ["https://cacoo.com/diagrams/*"], "url": "http://cacoo.com/oembed.{format}"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "http://img.catbo.at/",
        "endpoints":
            [{"schemes": ["http://img.catbo.at/*"], "url": "http://img.catbo.at/oembed.json", "formats": ["json"]}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "http://www.ceros.com/",
        "endpoints":
            [{"schemes": ["http://view.ceros.com/*"], "url": "http://view.ceros.com/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
        ...
        "endpoints":
            [{"schemes": ["http://public.chartblocks.com/c/*"], "url": "http://embed.chartblocks.com/1.0/oembed"}]
    }
    ,
    {
        "provider_name":
        ...
        "endpoints":
            [{"schemes": ["http://chirb.it/*"], "url": "http://chirb.it/oembed.{format}", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://codepen.io",
        "endpoints":
            [{"schemes": ["http://codepen.io/*", "https://codepen.io/*"], "url": "http://codepen.io/api/oembed"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://commaful.com",
        "endpoints":
            [{"schemes": ["https://commaful.com/play/*"], "url": "https://commaful.com/api/oembed/"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"schemes": ["http://crowdranking.com/*/*"], "url": "http://crowdranking.com/api/oembed.{format}"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"schemes": ["https://*.deseret.com/*"], "url": "https://embed.deseret.com/"}]
    }
    ,
    {
        "provider_name":
        ...
        "endpoints":
            [{
                "schemes": ["http://*.deviantart.com/art/*", "http://*.deviantart.com/*#/d*", "http://fav.me/*", "http://sta.sh/*", "https://*.deviantart.com/art/*", "https://*.deviantart.com/*/art/*", "https://sta.sh/*\",", "https://*.deviantart.com/*#/d*\""],
    ...
    ,
    {
        ...
        "provider_url":
            "http://www.dipity.com",
        "endpoints":
            [{"schemes": ["http://www.dipity.com/*/*/"], "url": "http://www.dipity.com/oembed/timeline/"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "http://dotsub.com/",
        "endpoints":
            [{"schemes": ["http://dotsub.com/view/*"], "url": "http://dotsub.com/services/oembed"}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "https://d.tube/",
        "endpoints":
            [{"schemes": ["https://d.tube/v/*"], "url": "https://api.d.tube/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "http://www.edocr.com",
        "endpoints":
            [{"schemes": ["http://edocr.com/docs/*"], "url": "http://edocr.com/api/oembed"}]
    }
    ,
    {
        "provider_name":
        ...
        "endpoints":
            [{
                ...
                "discovery": true
            }, {"url": "https://www.edumedia-sciences.com/oembed.xml", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"schemes": ["http://embedarticles.com/*"], "url": "http://embedarticles.com/oembed/"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://www.facebook.com/*/posts/*", "https://www.facebook.com/photos/*", "https://www.facebook.com/*/photos/*", "https://www.facebook.com/photo.php*", "https://www.facebook.com/photo.php", "https://www.facebook.com/*/activity/*", "https://www.facebook.com/permalink.php", "https://www.facebook.com/media/set?set=*", "https://www.facebook.com/questions/*", "https://www.facebook.com/notes/*/*/*"],
    ...
    ,
    {
        ...
        "provider_url":
            "https://www.fite.tv/",
        "endpoints":
            [{"schemes": ["https://www.fite.tv/watch/*"], "url": "https://www.fite.tv/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"schemes": ["https://catapult.fontself.com/*"], "url": "https://oembed.fontself.com/"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"schemes": ["http://gty.im/*"], "url": "http://embed.gettyimages.com/oembed", "formats": ["json"]}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://gloria.tv/",
        "endpoints":
            [{"url": "https://gloria.tv/oembed/", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://gyazo.com",
        "endpoints":
            [{"schemes": ["https://gyazo.com/*"], "url": "https://api.gyazo.com/api/oembed", "formats": ["json"]}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "http://huffduffer.com",
        "endpoints":
            [{"schemes": ["http://huffduffer.com/*/*"], "url": "http://huffduffer.com/oembed"}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "http://www.hulu.com/",
        "endpoints":
            [{"schemes": ["http://www.hulu.com/watch/*"], "url": "http://www.hulu.com/api/oembed.{format}"}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "http://www.iFixit.com",
        "endpoints":
            [{"schemes": ["http://www.ifixit.com/Guide/View/*"], "url": "http://www.ifixit.com/Embed"}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "http://www.ifttt.com/",
        "endpoints":
            [{"schemes": ["http://ifttt.com/recipes/*"], "url": "http://www.ifttt.com/oembed/", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://infogram.com/",
        "endpoints":
            [{"schemes": ["https://infogram.com/*"], "url": "https://infogram.com/oembed"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "http://inphood.com/",
        "endpoints":
            [{"schemes": ["http://*.inphood.com/*"], "url": "http://api.inphood.com/oembed", "formats": ["json"]}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"schemes": ["https://www.isnare.com/*"], "url": "https://www.isnare.com/oembed/"}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "https://issuu.com/",
        "endpoints":
            [{"schemes": ["https://issuu.com/*/docs/*"], "url": "https://issuu.com/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
        ...
        "endpoints":
            [{"url": "https://music.ivlis.kr/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
        ...
        "endpoints":
            [{
                "schemes": ["https://jovian.ml/*", "https://jovian.ml/viewer*", "https://*.jovian.ml/*"],
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://tv.kakao.com/channel/*/cliplink/*", "https://tv.kakao.com/channel/v/*", "https://tv.kakao.com/channel/*/livelink/*", "https://tv.kakao.com/channel/l/*"],
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://livestream.com/accounts/*/events/*", "https://livestream.com/accounts/*/events/*/videos/*", "https://livestream.com/*/events/*", "https://livestream.com/*/events/*/videos/*", "https://livestream.com/*/*", "https://livestream.com/*/*/videos/*"],
    ...
    ,
    {
        ...
        "endpoints":
            [{"url": "https://my.matterport.com/api/v1/models/oembed/", "discovery": true, "formats": ["json"]}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "https://me.me/",
        "endpoints":
            [{"schemes": ["https://me.me/i/*"], "url": "https://me.me/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://mybeweeg.com",
        "endpoints":
            [{"schemes": ["https://mybeweeg.com/w/*"], "url": "https://mybeweeg.com/services/oembed"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["http://*.nanoo.tv/link/*", "http://nanoo.tv/link/*", "http://*.nanoo.pro/link/*", "http://nanoo.pro/link/*", "https://*.nanoo.tv/link/*", "https://nanoo.tv/link/*", "https://*.nanoo.pro/link/*", "https://nanoo.pro/link/*", "http://media.zhdk.ch/signatur/*", "http://new.media.zhdk.ch/signatur/*", "https://media.zhdk.ch/signatur/*", "https://new.media.zhdk.ch/signatur/*"],
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://naturalatlas.com/*", "https://naturalatlas.com/*/*", "https://naturalatlas.com/*/*/*", "https://naturalatlas.com/*/*/*/*"],
    ...
    ,
    {
        ...
        "provider_url":
            "http://on.aol.com/",
        "endpoints":
            [{"schemes": ["http://on.aol.com/video/*"], "url": "http://on.aol.com/api"}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "http://www.ora.tv/",
        "endpoints":
            [{"discovery": true, "url": "https://www.ora.tv/oembed/*?format={format}"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://www.oumy.com/",
        "endpoints":
            [{"schemes": ["https://www.oumy.com/v/*"], "url": "https://www.oumy.com/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"url": "https://beta.pingvp.com.kpnis.nl/p/oembed.php", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"schemes": ["https://portfolium.com/entry/*"], "url": "https://api.portfolium.com/oembed"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        "provider_name":
            "RapidEngage",
        "provider_url":
            "https://rapidengage.com",
        "endpoints":
            [{"schemes": ["https://rapidengage.com/s/*"], "url": "https://rapidengage.com/api/oembed"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://repl.it/",
        "endpoints":
            [{"schemes": ["https://repl.it/@*/*"], "url": "https://repl.it/data/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"url": "https://www.riffreporter.de/service/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://rumble.com/",
        "endpoints":
            [{"url": "https://rumble.com/api/Media/oembed.{format}", "discovery": true}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "http://videos.sapo.pt",
        "endpoints":
            [{"schemes": ["http://videos.sapo.pt/*"], "url": "http://videos.sapo.pt/oembed"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"url": "https://api.screencast.com/external/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
        ...
        "endpoints":
            [{"schemes": ["http://www.screenr.com/*/"], "url": "http://www.screenr.com/api/oembed.{format}"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "http://www.scribd.com/",
        "endpoints":
            [{"schemes": ["http://www.scribd.com/doc/*"], "url": "http://www.scribd.com/services/oembed/"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "http://shoudio.com",
        "endpoints":
            [{"schemes": ["http://shoudio.com/*", "http://shoud.io/*"], "url": "http://shoudio.com/api/oembed"}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "https://showtheway.io",
        "endpoints":
            [{"schemes": ["https://showtheway.io/to/*"], "url": "https://showtheway.io/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://onsizzle.com/",
        "endpoints":
            [{"schemes": ["https://onsizzle.com/i/*"], "url": "https://onsizzle.com/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://spotify.com/",
        "endpoints":
            [{"schemes": ["https://*.spotify.com/*", "spotify:*"], "url": "https://embed.spotify.com/oembed/"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "http://www.topy.se/",
        "endpoints":
            [{"schemes": ["http://www.topy.se/image/*"], "url": "http://www.topy.se/oembed/", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://typlog.com",
        "endpoints":
            [{"url": "https://typlog.com/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://map.cam.ac.uk",
        "endpoints":
            [{"schemes": ["https://map.cam.ac.uk/*"], "url": "https://map.cam.ac.uk/oembed/"}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{
                ...
                "discovery": true
            }, {"schemes": ["http://veervr.tv/videos/*"], "url": "https://api.veervr.tv/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://vidl.it/",
        "endpoints":
            [{"schemes": ["https://vidl.it/*"], "url": "https://api.vidl.it/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["http://embed.vidyard.com/*", "http://play.vidyard.com/*", "http://share.vidyard.com/*", "http://*.hubs.vidyard.com/*"],
    ...
    ,
    {
        ...
        "provider_url":
            "https://vizydrop.com",
        "endpoints":
            [{"schemes": ["https://vizydrop.com/shared/*"], "url": "https://vizydrop.com/oembed"}]
    }
    ,
    {
        "provider_name":
        ...
        "provider_url":
            "https://vlipsy.com/",
        "endpoints":
            [{"schemes": ["https://vlipsy.com/*"], "url": "https://vlipsy.com/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{"url": "http://play.wecandeo.com/oembed", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "endpoints":
            [{
                "schemes": ["https://fast.wistia.com/embed/iframe/*", "https://fast.wistia.com/embed/playlists/*", "https://*.wistia.com/medias/*"],
    ...
    ,
    {
        ...
        "provider_url":
            "http://wordpress.com/",
        "endpoints":
            [{"url": "http://public-api.wordpress.com/oembed/", "discovery": true}]
    }
    ,
    {
        "provider_name":
    ...
    ,
    {
        ...
        "provider_url":
            "https://www.znipe.tv/",
        "endpoints":
            [{"schemes": ["https://*.znipe.tv/*"], "url": "https://api.znipe.tv/v3/oembed/", "discovery": true}]
    }
]
